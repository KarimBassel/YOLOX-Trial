...
def detect_and_visualize(model, image, input_size, class_names, tag):
    ...
    with torch.no_grad():
        ...
        outputs = postprocess(outputs, num_classes=80, conf_thre=0.3, nms_thre=0.3)
    ...
    if outputs[0] is not None:
        ...
        result_img = visualize(image.copy(), bboxes, scores, cls_ids, class_names, conf_threshold=0.3)
...
def main():
    weights_path = r"C:\Users\Karim Bassel\Downloads\YoloX trial code\weights\yolox-small.pth" 
    hgd_ckpt_path = r"best_ckpt.pt"  # path to trained HGD model
    input_size = (640, 640)
    image_path = r"C:\Users\Karim Bassel\Downloads\YoloX trial code\Dataset\coco128\coco128\attacked_images1024\val\000000000002_5.jpg"
