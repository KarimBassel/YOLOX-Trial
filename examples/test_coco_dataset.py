...
def main():
    ...
    image_path = r"C:\Users\Karim Bassel\Downloads\YoloX trial code\Dataset\coco128\coco128\val2017\000000000003.jpg"
    ...
    with torch.no_grad():
        ...
        outputs = postprocess(outputs, num_classes=80, conf_thre=0.4, nms_thre=0.3)
